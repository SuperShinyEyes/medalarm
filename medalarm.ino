/*
LCD manipulation by Ahmed Murtaza Qureshi (www.engineeringlearning.blogspot.com)
*/

/*
RTC library is originally by Dr.Ayars (http://hacks.ayars.org/2011/04/ds3231-real-time-clock.html)
For Medalarm, you must use the one I edited. 
(http://youngxotaniemi.wordpress.com/2014/12/03/arduino-24-ds3231_weekday_accessable/)
*/

/*
Medicine Alarm vers.1
Created by Seyoung Park (http://youngxotaniemi.wordpress.com/)
